...
// This class is applied to the sprint and rotation lock indicators that
// are present in the HUD. It controls the colour and state of specific
// components to provide the highlighting effect.
